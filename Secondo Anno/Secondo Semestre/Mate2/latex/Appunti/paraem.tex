...
\usepackage{geometry}
\geometry{a4paper, margin=1.25cm}\usepackage{titlesec}       % Personalizzazione dei titoli
...
\newtheorem{propo/home/nicholas/Scrivania/Uni/Primo Anno/Architettura/Latex/paraem.texsition}[theorem]{Proposizione}
